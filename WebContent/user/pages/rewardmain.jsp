            ...
            <div class="container">
        	 ...
        	 <div class="sort-by-section clearfix box">
                   <ul class="sort-bar clearfix block-sm">
                   	   <li><a href="#" class="button print-button btn-small uppercase">테크/가전</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">패션/뷰티</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">푸드</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">디자인소품</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">공연/컬쳐</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">소셜/캠페인</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">교육/키즈</a></li>
                   	   <li><a href="#" class="button print-button btn-small uppercase">게임/취미</a></li>
                    </ul>
             </div>
