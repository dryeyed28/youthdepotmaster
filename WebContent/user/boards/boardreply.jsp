...
<head>
    ...
    <!-- Current Page Styles -->
    <link rel="stylesheet" type="text/css" href="./resource/components/revolution_slider/css/settings.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="./resource/components/revolution_slider/css/style.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="./resource/components/jquery.bxslider/jquery.bxslider.css" media="screen" />
    <link rel="stylesheet" type="text/css" href="./resource/components/flexslider/flexslider.css" media="screen" />
    
    <!-- Main Style -->
    <link id="main-style" rel="stylesheet" href="./resource/css/style.css">
    
    <!-- Updated Styles -->
    <link rel="stylesheet" href="./resource/css/updates.css">
...
<body>
	<table summary="ì ì²´ íì´ë¸ êµ¬ì±">
 	<tr>
  		<td bgcolor=#dcdcdc height=25 align=center>ëµë³ë¬ê¸°</td>
 	</tr>
	</table><br>

	<table summary= "ëµë³ íì´ë¸ êµ¬ì±">
	<form name="BoardReplyForm" method="post" action="Board_Reply_action.jsp" 
 	...
 	<tr>
	    ...
	    <tr>
			...
			<td > <label>ìì±ìID</label></td>
    	</tr>
    	
    	
		<tr>
			<td width=10% align="center">ì  ëª©</td>
			<td width=50%><input type=text name=title size=50 maxlength=30 value="RE : ê²ìí ê¸ìëë¤."></td>
		</tr>
		<tr>
			<td width=10% align="center">ë´ ì©</td>
			<td><textarea name=content rows=10 cols=70> ê°ëë¤ë¼ë§ë°ì¬
...
|ëê¸|
		...
		<tr>
			...
			<input type="submit" value="ëµë³ ë±ë¡" class="btn" >&nbsp;
			<input type="button" value="ë¤ë¡ê°ê¸°" onclick="javascript:history.back()">
			</td>
		</tr> 
		</table>
		</td>
   ...
   <!-- Javascript -->
    ...
    <script type="text/javascript" src="./resource/js/jquery.noconflict.js"></script>
    <script type="text/javascript" src="./resource/js/modernizr.2.7.1.min.js"></script>
    <script type="text/javascript" src="./resource/js/jquery-migrate-1.2.1.min.js"></script>
    <script type="text/javascript" src="./resource/js/jquery.placeholder.js"></script>
    <script type="text/javascript" src="./resource/js/jquery-ui.1.10.4.min.js"></script>
    
    <!-- Twitter Bootstrap -->
    <script type="text/javascript" src="./resource/js/bootstrap.js"></script>
    
    <!-- load revolution slider scripts -->
    <script type="text/javascript" src="./resource/components/revolution_slider/js/jquery.themepunch.tools.min.js"></script>
    <script type="text/javascript" src="./resource/components/revolution_slider/js/jquery.themepunch.revolution.min.js"></script>
    
    <!-- load BXSlider scripts -->
    <script type="text/javascript" src="./resource/components/jquery.bxslider/jquery.bxslider.min.js"></script>
    
    <!-- load FlexSlider scripts -->
    <script type="text/javascript" src="./resource/components/flexslider/jquery.flexslider-min.js"></script>
    
    <script type="text/javascript" src="./resource/js/calendar.js"></script>
    
    <!-- parallax -->
    <script type="text/javascript" src="./resource/js/jquery.stellar.min.js"></script>
    
    <!-- waypoint -->
    <script type="text/javascript" src="./resource/js/waypoints.min.js"></script>

    <!-- load page Javascript -->
    <script type="text/javascript" src="./resource/js/theme-scripts.js"></script>
