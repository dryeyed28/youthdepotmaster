...
<div id="page-wrapper">
  ...
  <div class="row">
	<div class="col-lg-12">
      ...
      <hr>
      <button id="edit" onclick="location.href='<%= request.getContextPath()%>/admin/boardMng/edit.jsp?brd_id=<%=request.getParameter("brd_id")%>'" class="btn btn-outline btn-primary">글쓰기</button>&nbsp;&nbsp;
