...
values (1,1,1,1000,9000,to_date('18/05/25','RR/MM/DD'),'입금완료');
Insert into DEPOSIT (DEP_ID,MEM_ID,DEP_TYPE,DEP_REQUEST,DEP_BALANCE,DEP_DATE,DEP_STATE) 
values (2,2,2,10000,50000,to_date('18/05/25','RR/MM/DD'),'입금대기');
Insert into DEPOSIT (DEP_ID,MEM_ID,DEP_TYPE,DEP_REQUEST,DEP_BALANCE,DEP_DATE,DEP_STATE) 
values (3,3,3,10000,0,to_date('18/05/25','RR/MM/DD'),'입금취소');
Insert into DEPOSIT (DEP_ID,MEM_ID,DEP_TYPE,DEP_REQUEST,DEP_BALANCE,DEP_DATE,DEP_STATE) 
values (4,4,1,10000,0,to_date('18/05/25','RR/MM/DD'),'입금완료');
Insert into DEPOSIT (DEP_ID,MEM_ID,DEP_TYPE,DEP_REQUEST,DEP_BALANCE,DEP_DATE,DEP_STATE) 
values (5,5,2,10000,90000,to_date('18/05/25','RR/MM/DD'),'입금완료');
